...
-- CreateEnum
CREATE TYPE "LecturerRole" AS ENUM ('PROVOST', 'DEAN', 'HOD', 'PART_ADVISER', 'COURSE_LECTURER');
...
CREATE TABLE "course_session_department_levels" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "resultStatus" "DeptResultStatus" NOT NULL DEFAULT 'NOT_UPLOADED',
    "publishedAt" TIMESTAMP(3),
    "level" "Level" NOT NULL,
    "departmentId" TEXT NOT NULL,
    "courseSessionId" TEXT NOT NULL,
...
CREATE TABLE "enrollments" (
    ...
    "levelAtEnrollment" "Level" NOT NULL,
...
CREATE TABLE "result_uploads" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "deletedAt" TIMESTAMP(3),
    "resultType" "ResultType" NOT NULL DEFAULT 'INITIAL',
    "courseSessionId" TEXT NOT NULL,
...
CREATE TABLE "approval_flows" (
    ...
    "courseSesnDeptLevelId" TEXT NOT NULL,
    "lecturerId" TEXT NOT NULL,
    "courseType" "CourseType" NOT NULL DEFAULT 'INTER',
...
-- CreateIndex
CREATE UNIQUE INDEX "approval_flows_courseSesnDeptLevelId_key" ON "approval_flows"("courseSesnDeptLevelId");
...
-- AddForeignKey
ALTER TABLE "lecturer_designations" ADD CONSTRAINT "lecturer_designations_lecturerId_fkey" FOREIGN KEY ("lecturerId") REFERENCES "lecturers"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "course_sessions" ADD CONSTRAINT "course_sessions_gradingSystemId_fkey" FOREIGN KEY ("gradingSystemId") REFERENCES "grading_systems"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "course_sessions" ADD CONSTRAINT "course_sessions_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "grading_fields" ADD CONSTRAINT "grading_fields_gradingSystemId_fkey" FOREIGN KEY ("gradingSystemId") REFERENCES "grading_systems"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "grading_ranges" ADD CONSTRAINT "grading_ranges_gradingSystemId_fkey" FOREIGN KEY ("gradingSystemId") REFERENCES "grading_systems"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "course_lecturers" ADD CONSTRAINT "course_lecturers_courseSessionId_fkey" FOREIGN KEY ("courseSessionId") REFERENCES "course_sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "course_lecturers" ADD CONSTRAINT "course_lecturers_lecturerId_fkey" FOREIGN KEY ("lecturerId") REFERENCES "lecturers"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "course_session_department_levels" ADD CONSTRAINT "course_session_department_levels_departmentId_fkey" FOREIGN KEY ("departmentId") REFERENCES "departments"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "course_session_department_levels" ADD CONSTRAINT "course_session_department_levels_courseSessionId_fkey" FOREIGN KEY ("courseSessionId") REFERENCES "course_sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "result_uploads" ADD CONSTRAINT "result_uploads_courseSessionId_fkey" FOREIGN KEY ("courseSessionId") REFERENCES "course_sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "result_uploads" ADD CONSTRAINT "result_uploads_courseSesnDeptLevelId_fkey" FOREIGN KEY ("courseSesnDeptLevelId") REFERENCES "course_session_department_levels"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "result_uploads" ADD CONSTRAINT "result_uploads_uploadedById_fkey" FOREIGN KEY ("uploadedById") REFERENCES "lecturers"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "files" ADD CONSTRAINT "files_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pipeline_templates" ADD CONSTRAINT "pipeline_templates_createdByDeanId_fkey" FOREIGN KEY ("createdByDeanId") REFERENCES "lecturers"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pipeline_templates" ADD CONSTRAINT "pipeline_templates_activatedById_fkey" FOREIGN KEY ("activatedById") REFERENCES "lecturers"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "pipeline_template_steps" ADD CONSTRAINT "pipeline_template_steps_pipelineTemplateId_fkey" FOREIGN KEY ("pipelineTemplateId") REFERENCES "pipeline_templates"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pipeline_template_activations" ADD CONSTRAINT "pipeline_template_activations_pipelineTemplateId_fkey" FOREIGN KEY ("pipelineTemplateId") REFERENCES "pipeline_templates"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pipeline_template_activations" ADD CONSTRAINT "pipeline_template_activations_activatedById_fkey" FOREIGN KEY ("activatedById") REFERENCES "lecturers"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pipeline_template_activations" ADD CONSTRAINT "pipeline_template_activations_facultyId_fkey" FOREIGN KEY ("facultyId") REFERENCES "faculties"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "approval_flows" ADD CONSTRAINT "approval_flows_courseSesnDeptLevelId_fkey" FOREIGN KEY ("courseSesnDeptLevelId") REFERENCES "course_session_department_levels"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "approval_flows" ADD CONSTRAINT "approval_flows_pipelineTemplateId_fkey" FOREIGN KEY ("pipelineTemplateId") REFERENCES "pipeline_templates"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "approval_requests" ADD CONSTRAINT "approval_requests_approvalFlowId_fkey" FOREIGN KEY ("approvalFlowId") REFERENCES "approval_flows"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "approval_requests" ADD CONSTRAINT "approval_requests_lecturerDesignationId_fkey" FOREIGN KEY ("lecturerDesignationId") REFERENCES "lecturer_designations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "approval_snapshots" ADD CONSTRAINT "approval_snapshots_approvalRequestId_fkey" FOREIGN KEY ("approvalRequestId") REFERENCES "approval_requests"("id") ON DELETE CASCADE ON UPDATE CASCADE;
